...
Physical Volume("sphere_1.00") = {5:20};
Physical Volume("sphere_2.00") = {21:35};

s0 = BooleanIntersection{ Surface{1}; }{Volume{5:20}; };
Physical Surface("sphere_1.00") = s0();
s1 = BooleanIntersection{ Surface{1}; }{Volume{21:35}; };
