...
# PROJECT_SOURCE = "/path/to/project/source" (e.g. /home/mtcampbe/Nightly/IRProject)
# PROJECT_ROOT = "full/repository/path/to/project" (e.g. svn://irsvn/SourceRepository/IRProject/trunk)
...
MESSAGE("\n***** Building Project *****\n")
ctest_build()
# I want to turn this part on and off per input based on a project by project basis
  #MESSAGE("Building documentation  ${_BUILD_DOCUMENTATION_}")
  #MESSAGE("CMAKE_CONFIGURATION_OPTIONS  ${_CMAKE_CONFIGURATION_OPTIONS_}")
IF(${_BUILD_DOCUMENTATION_} MATCHES TRUE)
  #MESSAGE("Building documentation indicated by ${_DOCUMENTATION_TARGET_}")
