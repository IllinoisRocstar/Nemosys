...
Physical Volume("sphere_1.00") = {5:10};
Physical Volume("sphere_2.00") = {11:16};
s0 = BooleanIntersection{ Surface{1}; }{Volume{5:10}; };
Physical Surface("sphere_1.00") = s0();
s1 = BooleanIntersection{ Surface{1}; }{Volume{11:16}; };
Physical Surface("sphere_2.00") = s1();
