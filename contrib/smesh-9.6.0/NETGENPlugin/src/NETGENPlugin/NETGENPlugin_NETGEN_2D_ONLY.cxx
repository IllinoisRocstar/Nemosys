...
namespace netgen {
  ...
  extern void OCCSetLocalMeshSize(const OCCGeometry &geom, Mesh &mesh,
...
#ifdef NETGEN_V6
    const double factor = netgen::mparam.closeedgefac.value_or(1);
//    netgen::mparam.resthcloseedgeenable = false;
#else
