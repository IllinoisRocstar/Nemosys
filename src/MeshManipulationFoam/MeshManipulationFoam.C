...
added in future.
*/
void MeshManipulationFoam::createPatchDict()
{
...
{\n\
  ...
  //const char dir_path2[] = "./system/" + (_mshMnipPrms->pathPacks);
...
*/
void MeshManipulationFoam::createPatch()
{
  using namespace Foam;
  ...
  std::string secondPtch = _mshMnipPrms->pathPacks;
  std::string regnName;
