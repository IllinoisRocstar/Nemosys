...
//              entity->getMeshElement(j)->getVertexVTK(k)->getIndex() - 1);
        ...
        MElement::getInfoMSH(entity->getMeshElement(j)->getTypeForMSH(), typeName);
...
/* vv ------- Taken from Gmsh source: src/Geo/GModelIO_VTK.cpp:278 ------- vv */
    switch (type) {
      case 1: elements[0][1].push_back(new MPoint(cell)); break;
      // first order elements
      case 3: elements[1][1].push_back(new MLine(cell)); break;
      case 5: elements[2][1].push_back(new MTriangle(cell)); break;
      case 9: elements[3][1].push_back(new MQuadrangle(cell)); break;
      case 10: elements[4][1].push_back(new MTetrahedron(cell)); break;
      case 12: elements[5][1].push_back(new MHexahedron(cell)); break;
      case 13: elements[6][1].push_back(new MPrism(cell)); break;
      case 14: elements[7][1].push_back(new MPyramid(cell)); break;
      // second order elements
      case 21: elements[1][1].push_back(new MLine3(cell)); break;
      case 22: elements[2][1].push_back(new MTriangle6(cell)); break;
      case 23: elements[3][1].push_back(new MQuadrangle8(cell)); break;
      case 28: elements[3][1].push_back(new MQuadrangle9(cell)); break;
      case 24: elements[4][1].push_back(new MTetrahedron10(cell)); break;
      case 25: elements[5][1].push_back(new MHexahedron20(cell)); break;
      case 29: elements[5][1].push_back(new MHexahedron27(cell)); break;
