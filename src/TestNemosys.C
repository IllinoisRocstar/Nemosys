...
namespace Nemosys{
  ...
  int Test(int argc,char *argv[])
  {
    ...
    if(!comline.GetOption("help").empty()){
      ...
      if(verblevel > 2)
        std::cout << "Nemosys::Test: Exiting test function (success)" << std::endl;
      return(0);
    }
    if(clerr){
      ...
      if(verblevel > 2)
        std::cout << "Nemosys::Test: Exiting test function (fail)" << std::endl;
      return(1);
    }
    ...
    if(!OutFileName.empty()){
      ...
      if(!Ouf){
        std::cout << "Nemosys::Test> Error: Could not open output file, " 
    ...
    if(verblevel > 2)
      std::cout << "Nemosys::Test: Entering test function" << std::endl;
    
    // Make an instance of the Nemosys testing object, Nemosys::TestingObject
    Nemosys::TestingObject<Nemosys::TestResults> test;
    ...
    // run the listed tests.
      ...
      if(!ListInf){
        std::cout << "Nemosys::Test> Error: Could not open list of tests in file " 
    ...
    *Out << results << std::endl;
    ...
    if(verblevel > 2)
      *Out << "Nemosys::Test: Exiting test function (success)" << std::endl;
